...
const Hero: React.FC<HeroProps> = ({
  name = '[NAME]',
  text = 'I  build friendly we experience and help others become confident, modern developer',
}) => {
  return (
    <header className="text-center py-20 px-4 bg-gray-900 text-white transition-colors duration-300">
      ...
      <div className="flex justify-center gap-4">
        ...
        <Link
          to="/contact"
          className="border-blue-500 text-blue-400 px-6 py-2  hover:bg-blue-600  border hover:text-white transition "
        >
          Contact Me
        </Link>
      </div>
